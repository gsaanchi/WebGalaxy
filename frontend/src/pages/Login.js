...
export default function Login() {
   ...
   const handleLogin = async (e) => {
     ...
     try {
       ...
       navigate("/landing"); // Redirect to home page after login
     } catch (error) {
  ...
  return (
    <div className="bg-[radial-gradient(ellipse_at_top,#1a1a66_15%,#000033_40%,_#000000)] w-full h-[100vh] rounded-md flex justify-center items-center">
      <div className="w-3/5 bg-white rounded-md p-16 h-fit justify-center">
        <div className=" bg-white rounded ">
          ...
          <form onSubmit={handleLogin}>
            <div className="relative mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="mt-1 w-full text-sm pl-10 pr-4 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-600"
                />
                <svg
                  width="21"
            ...
            <button
              type="submit"
              className="w-full  text-sm text-white py-2 px-4 rounded-md bg-[#000033] mb-2"
            >
              Login
            </button>
            ...
            <div className="text-xs pt-4">
              ...
              <Link to="/" className="text-authButton hover:underline">
                Create new account here
              </Link>
            </div>
            <div className="text-xs pt-4 text-center text-red-500">
              <p>{error}</p>
            </div>
          </form>
          {/* <div className="flex mt-2 text-red-500 text-sm font-bold"></div> */}
        </div>
      </div>
    </div>
  );
