...
const Landing = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-[rgb(10,10,10)] via-[rgb(15,30,60)] to-[rgb(50,50,150)] text-white flex flex-col items-center before:absolute before:inset-0 before:bg-[linear-gradient(rgba(255,255,255,0.5)_1px,transparent_1px),linear-gradient(to_right,rgba(255,255,255,0.5)_1px,transparent_1px)] before:bg-[size:32px_32px] before:opacity-10 before:pointer-events-none">
      ...
      {/* Hero Section */}
      <div className="relative w-full flex-grow flex flex-col items-end justify-center p-16 pr-32 text-right">
        ...
        <div className="flex items-center rounded-md p-2 mt-20 w-full max-w-3xl ml-auto border-white relative bg-[#1F1F1F] shadow-lg">
          ...
          />
          <button className="absolute right-4 top-2 bottom-2 px-5 py-2 mt-2 mb-2 bg-[#0049F3] hover:bg-blue-700 rounded-lg text-white font-semibold transition-all flex items-center shadow-md">
            <svg
