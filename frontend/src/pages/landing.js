  ...
  return (
    <div className="flex flex-col">
      <div className="flex justify-between items-center p-4 bg-gray-50 shadow-md">
        <h1 className="text-2xl font-bold text-gray-800">WebGalaxy</h1>
      ...
      <div className="flex min-h-screen h-3/4 text-white">
        ...
        <div className="w-1/4 bg-indigo-300 p-4 m-2 border rounded-md">
          ...
          <div className="space-y-5">
            <div className="space-y-4">
              <div className="h-36 bg-indigo-400 rounded-lg"></div>{" "}
              {/* Increased height */}
              <div className="h-36 bg-indigo-400 rounded-lg"></div>
              <div className="h-36 bg-indigo-400 rounded-lg"></div>
              <div className="h-36 bg-indigo-400 rounded-lg"></div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center bg-gradient-to-br from-indigo-800 to-purple-900 relative m-2 border rounded-md">
          <h1 className="text-center text-2xl font-bold mb-8">
            No matter who you are, this is the only thing you need to build your
            website
          </h1>
          ...
          <div className="relative w-[400px] h-[400px] flex items-center justify-center">
            ...
            {/* Labels */}
            <div className="absolute top-4 left-8 text-sm bg-purple-700 px-2 py-1 rounded">
              Painter
            </div>
            <div className="absolute top-4 right-8 text-sm bg-purple-700 px-2 py-1 rounded">
              Florist
            </div>
            <div className="absolute bottom-18 left-8 text-sm bg-purple-700 px-2 py-1 rounded">
              Lawyer
            </div>
            <div className="absolute bottom-16 right-8 text-sm bg-purple-700 px-2 py-1 rounded">
              Doctor
            </div>
          </div>
        </div>
